...
class LoraConfig(PeftConfig):
    ...
    use_moe_lora_coeff: bool = field(
        default=False,
        metadata={
            "help": (
                "Use MoE-based LoRA with static A and B and trainable coefficients."
            )
        },
    )

    kaiming_init: bool = field(
        default=False,
        metadata={
            "help": (
                "Initialize LoRA B with Kaiming Normal."
            )
        },
    )
